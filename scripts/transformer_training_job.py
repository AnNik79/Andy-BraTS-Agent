"""Supervise a Transformer training run and record terminal failures."""
import argparse
import os
...
def main():
    ...
    try:
        ...
        destination = train_expert("transformer", records, splits, cfg,
        ...
        save_json(Path(cfg["output_dir"]) / "checkpoints" / "transformer" / "status.json",
